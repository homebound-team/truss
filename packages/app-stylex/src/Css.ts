...
declare module "react" {
  interface HTMLAttributes<T> { css?: CssProp; }
  interface SVGAttributes<T> { css?: CssProp; }
}
...
class CssBuilder<T extends Properties> {
 ...
 get bcBlack() { return this.add("borderColor", "#353535"); }
  /** Sets `borderColor: "#888888"`. */
 get bcMidGray() { return this.add("borderColor", "#888888"); }
  /** Sets `borderColor: "#cecece"`. */
 get bcLightGray() { return this.add("borderColor", "#cecece"); }
  /** Sets `borderColor: "#fcfcfa"`. */
 get bcWhite() { return this.add("borderColor", "#fcfcfa"); }
  /** Sets `borderColor: "#526675"`. */
 get bcBlue() { return this.add("borderColor", "#526675"); }
  /** Sets `borderColor: "var(--primary)"`. */
 get bcPrimary() { return this.add("borderColor", "var(--primary)"); }
 ...
 get bsn() { return this.add("borderStyle", "none"); }
  /** Sets `borderStyle: "solid"`. */
 get bss() { return this.add("borderStyle", "solid"); }
 ...
 get cts() { return this.add("containerType", "size"); }
  /** Sets `containerType: "inline-size"`. */
 get ctis() { return this.add("containerType", "inline-size"); }
  /** Sets `containerType: "normal"`. */
 get ctn() { return this.add("containerType", "normal"); }
  /** Sets `containerType: value`. */
 ct(value: Properties["containerType"]) { return this.add("containerType", value); }
  /** Sets `containerName: value`. */
 cn(value: Properties["containerName"]) { return this.add("containerName", value); }

  // coordinates
  /** Sets `top: "0px"`. */
 get top0() { return this.add("top", "0px"); }
  /** Sets `top: "8px"`. */
 get top1() { return this.add("top", "8px"); }
  /** Sets `top: "16px"`. */
 get top2() { return this.add("top", "16px"); }
  /** Sets `top: "24px"`. */
 get top3() { return this.add("top", "24px"); }
  /** Sets `top: "32px"`. */
 get top4() { return this.add("top", "32px"); }
  /** Sets `top: "v"`. */
 top(v: number | string) { return this.add("top", maybeInc(v)); }
  /** Sets `top: px`. */
 topPx(px: number) { return this.add("top", `${px}px`); }
  /** Sets `right: "0px"`. */
 get right0() { return this.add("right", "0px"); }
  /** Sets `right: "8px"`. */
 get right1() { return this.add("right", "8px"); }
  /** Sets `right: "16px"`. */
 get right2() { return this.add("right", "16px"); }
  /** Sets `right: "24px"`. */
 get right3() { return this.add("right", "24px"); }
  /** Sets `right: "32px"`. */
 get right4() { return this.add("right", "32px"); }
  /** Sets `right: "v"`. */
 right(v: number | string) { return this.add("right", maybeInc(v)); }
  /** Sets `right: px`. */
 rightPx(px: number) { return this.add("right", `${px}px`); }
  /** Sets `bottom: "0px"`. */
 get bottom0() { return this.add("bottom", "0px"); }
  /** Sets `bottom: "8px"`. */
 get bottom1() { return this.add("bottom", "8px"); }
  /** Sets `bottom: "16px"`. */
 get bottom2() { return this.add("bottom", "16px"); }
  /** Sets `bottom: "24px"`. */
 get bottom3() { return this.add("bottom", "24px"); }
  /** Sets `bottom: "32px"`. */
 get bottom4() { return this.add("bottom", "32px"); }
  /** Sets `bottom: "v"`. */
 bottom(v: number | string) { return this.add("bottom", maybeInc(v)); }
  /** Sets `bottom: px`. */
 bottomPx(px: number) { return this.add("bottom", `${px}px`); }
  /** Sets `left: "0px"`. */
 get left0() { return this.add("left", "0px"); }
  /** Sets `left: "8px"`. */
 get left1() { return this.add("left", "8px"); }
  /** Sets `left: "16px"`. */
 get left2() { return this.add("left", "16px"); }
  /** Sets `left: "24px"`. */
 get left3() { return this.add("left", "24px"); }
  /** Sets `left: "32px"`. */
 get left4() { return this.add("left", "32px"); }
  /** Sets `left: "v"`. */
 left(v: number | string) { return this.add("left", maybeInc(v)); }
  /** Sets `left: px`. */
 ...
 get jsa() { return this.add("justifySelf", "auto"); }
  /** Sets `justifySelf: "center"`. */
 get jsc() { return this.add("justifySelf", "center"); }
  /** Sets `justifySelf: "start"`. */
 get jss() { return this.add("justifySelf", "start"); }
  /** Sets `justifySelf: "end"`. */
 get jse() { return this.add("justifySelf", "end"); }
  /** Sets `justifySelf: value`. */
 js(value: Properties["justifySelf"]) { return this.add("justifySelf", value); }
 ...
 get ais() { return this.add("alignItems", "start"); }
  /** Sets `alignItems: "end"`. */
 get aie() { return this.add("alignItems", "end"); }
 ...
 ai(value: Properties["alignItems"]) { return this.add("alignItems", value); }
  /** Sets `placeSelf: "auto"`. */
 get psa() { return this.add("placeSelf", "auto"); }
  /** Sets `placeSelf: "center"`. */
 get psc() { return this.add("placeSelf", "center"); }
  /** Sets `placeSelf: "start"`. */
 get pss() { return this.add("placeSelf", "start"); }
  /** Sets `placeSelf: "end"`. */
 get pse() { return this.add("placeSelf", "end"); }
  /** Sets `placeSelf: "flex-start"`. */
 get psfs() { return this.add("placeSelf", "flex-start"); }
  /** Sets `placeSelf: "flex-end"`. */
 get psfe() { return this.add("placeSelf", "flex-end"); }
  /** Sets `placeSelf: "stretch"`. */
 get psStretch() { return this.add("placeSelf", "stretch"); }
  /** Sets `placeSelf: value`. */
 ps(value: Properties["placeSelf"]) { return this.add("placeSelf", value); }
  /** Sets `placeContent: "center"`. */
 get pcc() { return this.add("placeContent", "center"); }
  /** Sets `placeContent: "start"`. */
 get pcs() { return this.add("placeContent", "start"); }
  /** Sets `placeContent: "end"`. */
 get pce() { return this.add("placeContent", "end"); }
  /** Sets `placeContent: "space-between"`. */
 get pcsb() { return this.add("placeContent", "space-between"); }
  /** Sets `placeContent: "space-around"`. */
 get pcsa() { return this.add("placeContent", "space-around"); }
  /** Sets `placeContent: "space-evenly"`. */
 get pcse() { return this.add("placeContent", "space-evenly"); }
  /** Sets `placeContent: "baseline"`. */
 get pcb() { return this.add("placeContent", "baseline"); }
  /** Sets `placeContent: "stretch"`. */
 get pcStretch() { return this.add("placeContent", "stretch"); }
  /** Sets `placeContent: value`. */
 pc(value: Properties["placeContent"]) { return this.add("placeContent", value); }
  /** Sets `placeItems: "center"`. */
 get pic() { return this.add("placeItems", "center"); }
  /** Sets `placeItems: "start"`. */
 get pis() { return this.add("placeItems", "start"); }
  /** Sets `placeItems: "end"`. */
 get pie() { return this.add("placeItems", "end"); }
  /** Sets `placeItems: "space-between"`. */
 get pisb() { return this.add("placeItems", "space-between"); }
  /** Sets `placeItems: "space-around"`. */
 get pisa() { return this.add("placeItems", "space-around"); }
  /** Sets `placeItems: "space-evenly"`. */
 get pise() { return this.add("placeItems", "space-evenly"); }
  /** Sets `placeItems: "baseline"`. */
 get pib() { return this.add("placeItems", "baseline"); }
  /** Sets `placeItems: "stretch"`. */
 get piStretch() { return this.add("placeItems", "stretch"); }
  /** Sets `placeItems: value`. */
 pi(value: Properties["placeItems"]) { return this.add("placeItems", value); }
  /** Sets `flexBasis: "100%"`. */
 ...
 fd(value: Properties["flexDirection"]) { return this.add("flexDirection", value); }
  /** Sets `flexWrap: "wrap"`. */
 get fww() { return this.add("flexWrap", "wrap"); }
  /** Sets `flexWrap: "wrap-reverse"`. */
 get fwr() { return this.add("flexWrap", "wrap-reverse"); }
  /** Sets `flexWrap: "nowrap"`. */
 get fwnw() { return this.add("flexWrap", "nowrap"); }
  /** Sets `flexWrap: value`. */
 flexWrap(value: Properties["flexWrap"]) { return this.add("flexWrap", value); }
  /** Sets `order: value`. */
 order(value: Properties["order"]) { return this.add("order", value); }
 ...
 get fwn() { return this.add("fontWeight", "normal"); }
  /** Sets `fontWeight: "bold"`. */
 get fwb() { return this.add("fontWeight", "bold"); }
  /** Sets `fontWeight: 100`. */
 ...
 gar(value: Properties["gridAutoRows"]) { return this.add("gridAutoRows", value); }
  /** Sets `gridAutoColumns: value`. */
 gac(value: Properties["gridAutoColumns"]) { return this.add("gridAutoColumns", value); }
  /** Sets `gap: "0px"`. */
 get gap0() { return this.add("gap", "0px"); }
  /** Sets `gap: "8px"`. */
 get gap1() { return this.add("gap", "8px"); }
  /** Sets `gap: "16px"`. */
 get gap2() { return this.add("gap", "16px"); }
  /** Sets `gap: "24px"`. */
 get gap3() { return this.add("gap", "24px"); }
  /** Sets `gap: "32px"`. */
 get gap4() { return this.add("gap", "32px"); }
  /** Sets `gap: "v"`. */
 gap(v: number | string) { return this.add("gap", maybeInc(v)); }
  /** Sets `gap: px`. */
 gapPx(px: number) { return this.add("gap", `${px}px`); }
  /** Sets `rowGap: "0px"`. */
 get rg0() { return this.add("rowGap", "0px"); }
  /** Sets `rowGap: "8px"`. */
 get rg1() { return this.add("rowGap", "8px"); }
  /** Sets `rowGap: "16px"`. */
 get rg2() { return this.add("rowGap", "16px"); }
  /** Sets `rowGap: "24px"`. */
 get rg3() { return this.add("rowGap", "24px"); }
  /** Sets `rowGap: "32px"`. */
 get rg4() { return this.add("rowGap", "32px"); }
  /** Sets `rowGap: "v"`. */
 rg(v: number | string) { return this.add("rowGap", maybeInc(v)); }
  /** Sets `rowGap: px`. */
 rgPx(px: number) { return this.add("rowGap", `${px}px`); }
  /** Sets `columnGap: "0px"`. */
 get cg0() { return this.add("columnGap", "0px"); }
  /** Sets `columnGap: "8px"`. */
 get cg1() { return this.add("columnGap", "8px"); }
  /** Sets `columnGap: "16px"`. */
 get cg2() { return this.add("columnGap", "16px"); }
  /** Sets `columnGap: "24px"`. */
 get cg3() { return this.add("columnGap", "24px"); }
  /** Sets `columnGap: "32px"`. */
 get cg4() { return this.add("columnGap", "32px"); }
  /** Sets `columnGap: "v"`. */
 cg(v: number | string) { return this.add("columnGap", maybeInc(v)); }
  /** Sets `columnGap: px`. */
 cgPx(px: number) { return this.add("columnGap", `${px}px`); }

  // height
  /** Sets `height: "0px"`. */
 get h0() { return this.add("height", "0px"); }
  /** Sets `height: "8px"`. */
 get h1() { return this.add("height", "8px"); }
  /** Sets `height: "16px"`. */
 get h2() { return this.add("height", "16px"); }
  /** Sets `height: "24px"`. */
 get h3() { return this.add("height", "24px"); }
  /** Sets `height: "32px"`. */
 get h4() { return this.add("height", "32px"); }
  /** Sets `height: "auto"`. */
 get ha() { return this.add("height", "auto"); }
  /** Sets `height: "v"`. */
 h(v: number | string) { return this.add("height", maybeInc(v)); }
  /** Sets `height: px`. */
 ...
 get hfc() { return this.add("height", "fit-content"); }
  /** Sets `height: "max-content"`. */
 get hmaxc() { return this.add("height", "max-content"); }
  /** Sets `height: "min-content"`. */
 get hminc() { return this.add("height", "min-content"); }
  /** Sets `minHeight: 0`. */
 ...
 get lineClamp1() { return this.add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis").add("WebkitLineClamp", 1); }
  /** Sets `overflow: "hidden"; display: "-webkit-box"; WebkitBoxOrient: "vertical"; textOverflow: "ellipsis"; WebkitLineClamp: 2`. */
 get lineClamp2() { return this.add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis").add("WebkitLineClamp", 2); }
  /** Sets `overflow: "hidden"; display: "-webkit-box"; WebkitBoxOrient: "vertical"; textOverflow: "ellipsis"; WebkitLineClamp: 3`. */
 get lineClamp3() { return this.add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis").add("WebkitLineClamp", 3); }
  /** Sets `overflow: "hidden"; display: "-webkit-box"; WebkitBoxOrient: "vertical"; textOverflow: "ellipsis"; WebkitLineClamp: 4`. */
 get lineClamp4() { return this.add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis").add("WebkitLineClamp", 4); }
  /** Sets `overflow: "hidden"; display: "-webkit-box"; WebkitBoxOrient: "vertical"; textOverflow: "ellipsis"; WebkitLineClamp: 5`. */
 get lineClamp5() { return this.add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis").add("WebkitLineClamp", 5); }
  /** Sets `overflow: "hidden"; display: "-webkit-box"; WebkitBoxOrient: "vertical"; textOverflow: "ellipsis"; WebkitLineClamp: 6`. */
 get lineClamp6() { return this.add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis").add("WebkitLineClamp", 6); }
  /** Sets `WebkitLineClamp: "unset"`. */
 get lineClampNone() { return this.add("WebkitLineClamp", "unset"); }
  /** Sets `WebkitLineClamp: value`. */
 lineClamp(value: Properties["WebkitLineClamp"]) { return this.add("WebkitLineClamp", value).add("overflow", "hidden").add("display", "-webkit-box").add("WebkitBoxOrient", "vertical").add("textOverflow", "ellipsis"); }
 ...
 objectFit(value: Properties["objectFit"]) { return this.add("objectFit", value); }
  ...
  // opacity
  /** Sets `opacity: "0"`. */
 get o0() { return this.add("opacity", "0"); }
  /** Sets `opacity: "0.25"`. */
 get o25() { return this.add("opacity", "0.25"); }
  /** Sets `opacity: "0.5"`. */
 get o50() { return this.add("opacity", "0.5"); }
  /** Sets `opacity: "0.75"`. */
 get o75() { return this.add("opacity", "0.75"); }
  /** Sets `opacity: "1"`. */
 get o100() { return this.add("opacity", "1"); }
  /** Sets `opacity: value`. */
 o(value: Properties["opacity"]) { return this.add("opacity", value); }
 ...
 get ov() { return this.add("overflow", "visible"); }
  /** Sets `overflow: "hidden"`. */
 get oh() { return this.add("overflow", "hidden"); }
  /** Sets `overflow: "scroll"`. */
 get os() { return this.add("overflow", "scroll"); }
  /** Sets `overflow: "auto"`. */
 get oa() { return this.add("overflow", "auto"); }
  /** Sets `overflow: value`. */
 overflow(value: Properties["overflow"]) { return this.add("overflow", value); }
  /** Sets `overflowY: "visible"`. */
 get oyv() { return this.add("overflowY", "visible"); }
  /** Sets `overflowY: "hidden"`. */
 get oyh() { return this.add("overflowY", "hidden"); }
  /** Sets `overflowY: "scroll"`. */
 get oys() { return this.add("overflowY", "scroll"); }
  /** Sets `overflowY: "auto"`. */
 get oya() { return this.add("overflowY", "auto"); }
  /** Sets `overflowY: value`. */
 overflowY(value: Properties["overflowY"]) { return this.add("overflowY", value); }
  /** Sets `overflowX: "visible"`. */
 get oxv() { return this.add("overflowX", "visible"); }
  /** Sets `overflowX: "hidden"`. */
 get oxh() { return this.add("overflowX", "hidden"); }
  /** Sets `overflowX: "scroll"`. */
 get oxs() { return this.add("overflowX", "scroll"); }
  /** Sets `overflowX: "auto"`. */
 get oxa() { return this.add("overflowX", "auto"); }
 ...
 get mt3() { return this.add("marginTop", "24px"); }
  /** Sets `marginTop: "32px"`. */
 get mt4() { return this.add("marginTop", "32px"); }
  /** Sets `marginTop: "auto"`. */
 ...
 get mr0() { return this.add("marginRight", "0px"); }
  /** Sets `marginRight: "8px"`. */
 get mr1() { return this.add("marginRight", "8px"); }
  /** Sets `marginRight: "16px"`. */
 get mr2() { return this.add("marginRight", "16px"); }
  /** Sets `marginRight: "24px"`. */
 get mr3() { return this.add("marginRight", "24px"); }
  /** Sets `marginRight: "32px"`. */
 get mr4() { return this.add("marginRight", "32px"); }
  /** Sets `marginRight: "auto"`. */
 get mra() { return this.add("marginRight", "auto"); }
  /** Sets `marginRight: "v"`. */
 mr(v: number | string) { return this.add("marginRight", maybeInc(v)); }
  /** Sets `marginRight: px`. */
 mrPx(px: number) { return this.add("marginRight", `${px}px`); }
  /** Sets `marginBottom: "0px"`. */
 get mb0() { return this.add("marginBottom", "0px"); }
  /** Sets `marginBottom: "8px"`. */
 get mb1() { return this.add("marginBottom", "8px"); }
  /** Sets `marginBottom: "16px"`. */
 get mb2() { return this.add("marginBottom", "16px"); }
  /** Sets `marginBottom: "24px"`. */
 get mb3() { return this.add("marginBottom", "24px"); }
  /** Sets `marginBottom: "32px"`. */
 get mb4() { return this.add("marginBottom", "32px"); }
  /** Sets `marginBottom: "auto"`. */
 get mba() { return this.add("marginBottom", "auto"); }
  /** Sets `marginBottom: "v"`. */
 mb(v: number | string) { return this.add("marginBottom", maybeInc(v)); }
  /** Sets `marginBottom: px`. */
 mbPx(px: number) { return this.add("marginBottom", `${px}px`); }
  /** Sets `marginLeft: "0px"`. */
 get ml0() { return this.add("marginLeft", "0px"); }
  /** Sets `marginLeft: "8px"`. */
 get ml1() { return this.add("marginLeft", "8px"); }
  /** Sets `marginLeft: "16px"`. */
 get ml2() { return this.add("marginLeft", "16px"); }
  /** Sets `marginLeft: "24px"`. */
 get ml3() { return this.add("marginLeft", "24px"); }
  /** Sets `marginLeft: "32px"`. */
 get ml4() { return this.add("marginLeft", "32px"); }
  /** Sets `marginLeft: "auto"`. */
 get mla() { return this.add("marginLeft", "auto"); }
  /** Sets `marginLeft: "v"`. */
 ml(v: number | string) { return this.add("marginLeft", maybeInc(v)); }
  /** Sets `marginLeft: px`. */
 ...
 get mx4() { return this.add("marginLeft", "32px").add("marginRight", "32px"); }
 ...
 get my0() { return this.add("marginTop", "0px").add("marginBottom", "0px"); }
  /** Sets `marginTop: "8px"; marginBottom: "8px"`. */
 get my1() { return this.add("marginTop", "8px").add("marginBottom", "8px"); }
  /** Sets `marginTop: "16px"; marginBottom: "16px"`. */
 get my2() { return this.add("marginTop", "16px").add("marginBottom", "16px"); }
  /** Sets `marginTop: "24px"; marginBottom: "24px"`. */
 get my3() { return this.add("marginTop", "24px").add("marginBottom", "24px"); }
  /** Sets `marginTop: "32px"; marginBottom: "32px"`. */
 get my4() { return this.add("marginTop", "32px").add("marginBottom", "32px"); }
  /** Sets `marginTop: "auto"; marginBottom: "auto"`. */
 get mya() { return this.add("marginTop", "auto").add("marginBottom", "auto"); }
  /** Sets `marginTop: "v"; marginBottom: "v"`. */
 my(v: number | string) { return this.add("marginTop", maybeInc(v)).add("marginBottom", maybeInc(v)); }
  /** Sets `marginTop: px; marginBottom: px`. */
 myPx(px: number) { return this.add("marginTop", `${px}px`).add("marginBottom", `${px}px`); }
  /** Sets `marginTop: "0px"; marginBottom: "0px"; marginRight: "0px"; marginLeft: "0px"`. */
 get m0() { return this.add("marginTop", "0px").add("marginBottom", "0px").add("marginRight", "0px").add("marginLeft", "0px"); }
  /** Sets `marginTop: "8px"; marginBottom: "8px"; marginRight: "8px"; marginLeft: "8px"`. */
 get m1() { return this.add("marginTop", "8px").add("marginBottom", "8px").add("marginRight", "8px").add("marginLeft", "8px"); }
  /** Sets `marginTop: "16px"; marginBottom: "16px"; marginRight: "16px"; marginLeft: "16px"`. */
 get m2() { return this.add("marginTop", "16px").add("marginBottom", "16px").add("marginRight", "16px").add("marginLeft", "16px"); }
  /** Sets `marginTop: "24px"; marginBottom: "24px"; marginRight: "24px"; marginLeft: "24px"`. */
 get m3() { return this.add("marginTop", "24px").add("marginBottom", "24px").add("marginRight", "24px").add("marginLeft", "24px"); }
  /** Sets `marginTop: "32px"; marginBottom: "32px"; marginRight: "32px"; marginLeft: "32px"`. */
 get m4() { return this.add("marginTop", "32px").add("marginBottom", "32px").add("marginRight", "32px").add("marginLeft", "32px"); }
  /** Sets `marginTop: "auto"; marginBottom: "auto"; marginRight: "auto"; marginLeft: "auto"`. */
 get ma() { return this.add("marginTop", "auto").add("marginBottom", "auto").add("marginRight", "auto").add("marginLeft", "auto"); }
  /** Sets `marginTop: "v"; marginBottom: "v"; marginRight: "v"; marginLeft: "v"`. */
 m(v: number | string) { return this.add("marginTop", maybeInc(v)).add("marginBottom", maybeInc(v)).add("marginRight", maybeInc(v)).add("marginLeft", maybeInc(v)); }
  /** Sets `marginTop: px; marginBottom: px; marginRight: px; marginLeft: px`. */
 mPx(px: number) { return this.add("marginTop", `${px}px`).add("marginBottom", `${px}px`).add("marginRight", `${px}px`).add("marginLeft", `${px}px`); }
  /** Sets `paddingTop: "0px"`. */
 get pt0() { return this.add("paddingTop", "0px"); }
  /** Sets `paddingTop: "8px"`. */
 get pt1() { return this.add("paddingTop", "8px"); }
  /** Sets `paddingTop: "16px"`. */
 get pt2() { return this.add("paddingTop", "16px"); }
  /** Sets `paddingTop: "24px"`. */
 get pt3() { return this.add("paddingTop", "24px"); }
  /** Sets `paddingTop: "32px"`. */
 get pt4() { return this.add("paddingTop", "32px"); }
  /** Sets `paddingTop: "v"`. */
 pt(v: number | string) { return this.add("paddingTop", maybeInc(v)); }
  /** Sets `paddingTop: px`. */
 ptPx(px: number) { return this.add("paddingTop", `${px}px`); }
  /** Sets `paddingRight: "0px"`. */
 get pr0() { return this.add("paddingRight", "0px"); }
  /** Sets `paddingRight: "8px"`. */
 get pr1() { return this.add("paddingRight", "8px"); }
  /** Sets `paddingRight: "16px"`. */
 get pr2() { return this.add("paddingRight", "16px"); }
  /** Sets `paddingRight: "24px"`. */
 get pr3() { return this.add("paddingRight", "24px"); }
  /** Sets `paddingRight: "32px"`. */
 get pr4() { return this.add("paddingRight", "32px"); }
  /** Sets `paddingRight: "v"`. */
 pr(v: number | string) { return this.add("paddingRight", maybeInc(v)); }
  /** Sets `paddingRight: px`. */
 prPx(px: number) { return this.add("paddingRight", `${px}px`); }
  /** Sets `paddingBottom: "0px"`. */
 get pb0() { return this.add("paddingBottom", "0px"); }
  /** Sets `paddingBottom: "8px"`. */
 get pb1() { return this.add("paddingBottom", "8px"); }
  /** Sets `paddingBottom: "16px"`. */
 get pb2() { return this.add("paddingBottom", "16px"); }
  /** Sets `paddingBottom: "24px"`. */
 get pb3() { return this.add("paddingBottom", "24px"); }
  /** Sets `paddingBottom: "32px"`. */
 get pb4() { return this.add("paddingBottom", "32px"); }
  /** Sets `paddingBottom: "v"`. */
 pb(v: number | string) { return this.add("paddingBottom", maybeInc(v)); }
  /** Sets `paddingBottom: px`. */
 pbPx(px: number) { return this.add("paddingBottom", `${px}px`); }
  /** Sets `paddingLeft: "0px"`. */
 get pl0() { return this.add("paddingLeft", "0px"); }
  /** Sets `paddingLeft: "8px"`. */
 get pl1() { return this.add("paddingLeft", "8px"); }
  /** Sets `paddingLeft: "16px"`. */
 get pl2() { return this.add("paddingLeft", "16px"); }
  /** Sets `paddingLeft: "24px"`. */
 get pl3() { return this.add("paddingLeft", "24px"); }
  /** Sets `paddingLeft: "32px"`. */
 get pl4() { return this.add("paddingLeft", "32px"); }
  /** Sets `paddingLeft: "v"`. */
 pl(v: number | string) { return this.add("paddingLeft", maybeInc(v)); }
  /** Sets `paddingLeft: px`. */
 plPx(px: number) { return this.add("paddingLeft", `${px}px`); }
  /** Sets `paddingLeft: "0px"; paddingRight: "0px"`. */
 get px0() { return this.add("paddingLeft", "0px").add("paddingRight", "0px"); }
  /** Sets `paddingLeft: "8px"; paddingRight: "8px"`. */
 get px1() { return this.add("paddingLeft", "8px").add("paddingRight", "8px"); }
  /** Sets `paddingLeft: "16px"; paddingRight: "16px"`. */
 get px2() { return this.add("paddingLeft", "16px").add("paddingRight", "16px"); }
  /** Sets `paddingLeft: "24px"; paddingRight: "24px"`. */
 get px3() { return this.add("paddingLeft", "24px").add("paddingRight", "24px"); }
  /** Sets `paddingLeft: "32px"; paddingRight: "32px"`. */
 get px4() { return this.add("paddingLeft", "32px").add("paddingRight", "32px"); }
  /** Sets `paddingLeft: "v"; paddingRight: "v"`. */
 px(v: number | string) { return this.add("paddingLeft", maybeInc(v)).add("paddingRight", maybeInc(v)); }
  /** Sets `paddingLeft: px; paddingRight: px`. */
 pxPx(px: number) { return this.add("paddingLeft", `${px}px`).add("paddingRight", `${px}px`); }
  /** Sets `paddingTop: "0px"; paddingBottom: "0px"`. */
 get py0() { return this.add("paddingTop", "0px").add("paddingBottom", "0px"); }
  /** Sets `paddingTop: "8px"; paddingBottom: "8px"`. */
 get py1() { return this.add("paddingTop", "8px").add("paddingBottom", "8px"); }
  /** Sets `paddingTop: "16px"; paddingBottom: "16px"`. */
 get py2() { return this.add("paddingTop", "16px").add("paddingBottom", "16px"); }
  /** Sets `paddingTop: "24px"; paddingBottom: "24px"`. */
 get py3() { return this.add("paddingTop", "24px").add("paddingBottom", "24px"); }
  /** Sets `paddingTop: "32px"; paddingBottom: "32px"`. */
 get py4() { return this.add("paddingTop", "32px").add("paddingBottom", "32px"); }
  /** Sets `paddingTop: "v"; paddingBottom: "v"`. */
 py(v: number | string) { return this.add("paddingTop", maybeInc(v)).add("paddingBottom", maybeInc(v)); }
  /** Sets `paddingTop: px; paddingBottom: px`. */
 pyPx(px: number) { return this.add("paddingTop", `${px}px`).add("paddingBottom", `${px}px`); }
  /** Sets `paddingTop: "0px"; paddingBottom: "0px"; paddingRight: "0px"; paddingLeft: "0px"`. */
 get p0() { return this.add("paddingTop", "0px").add("paddingBottom", "0px").add("paddingRight", "0px").add("paddingLeft", "0px"); }
  /** Sets `paddingTop: "8px"; paddingBottom: "8px"; paddingRight: "8px"; paddingLeft: "8px"`. */
 get p1() { return this.add("paddingTop", "8px").add("paddingBottom", "8px").add("paddingRight", "8px").add("paddingLeft", "8px"); }
  /** Sets `paddingTop: "16px"; paddingBottom: "16px"; paddingRight: "16px"; paddingLeft: "16px"`. */
 get p2() { return this.add("paddingTop", "16px").add("paddingBottom", "16px").add("paddingRight", "16px").add("paddingLeft", "16px"); }
  /** Sets `paddingTop: "24px"; paddingBottom: "24px"; paddingRight: "24px"; paddingLeft: "24px"`. */
 get p3() { return this.add("paddingTop", "24px").add("paddingBottom", "24px").add("paddingRight", "24px").add("paddingLeft", "24px"); }
  /** Sets `paddingTop: "32px"; paddingBottom: "32px"; paddingRight: "32px"; paddingLeft: "32px"`. */
 get p4() { return this.add("paddingTop", "32px").add("paddingBottom", "32px").add("paddingRight", "32px").add("paddingLeft", "32px"); }
  /** Sets `paddingTop: "v"; paddingBottom: "v"; paddingRight: "v"; paddingLeft: "v"`. */
 p(v: number | string) { return this.add("paddingTop", maybeInc(v)).add("paddingBottom", maybeInc(v)).add("paddingRight", maybeInc(v)).add("paddingLeft", maybeInc(v)); }
  /** Sets `paddingTop: px; paddingBottom: px; paddingRight: px; paddingLeft: px`. */
 pPx(px: number) { return this.add("paddingTop", `${px}px`).add("paddingBottom", `${px}px`).add("paddingRight", `${px}px`).add("paddingLeft", `${px}px`); }

  // textAlign
  /** Sets `textAlign: "left"`. */
 get tal() { return this.add("textAlign", "left"); }
  /** Sets `textAlign: "center"`. */
 get tac() { return this.add("textAlign", "center"); }
  /** Sets `textAlign: "right"`. */
 get tar() { return this.add("textAlign", "right"); }
  /** Sets `textAlign: "justify"`. */
 get taj() { return this.add("textAlign", "justify"); }
  /** Sets `textAlign: value`. */
 ta(value: Properties["textAlign"]) { return this.add("textAlign", value); }

  // textDecoration
  /** Sets `textDecoration: "none"`. */
 get tdn() { return this.add("textDecoration", "none"); }
  /** Sets `textDecoration: "line-through"`. */
 get tdlt() { return this.add("textDecoration", "line-through"); }
  /** Sets `textDecoration: "underline"`. */
 get tdu() { return this.add("textDecoration", "underline"); }
 ...
 get truncate() { return this.add("whiteSpace", "nowrap").add("overflow", "hidden").add("textOverflow", "ellipsis"); }
  /** Sets `fontSize: value`. */
 fs(value: Properties["fontSize"]) { return this.add("fontSize", value); }
  /** Sets `fontSize: px`. */
 ...
 get usn() { return this.add("userSelect", "none"); }
  /** Sets `userSelect: "text"`. */
 get ust() { return this.add("userSelect", "text"); }
  /** Sets `userSelect: "all"`. */
 get usAll() { return this.add("userSelect", "all"); }
  /** Sets `userSelect: "auto"`. */
 get usAuto() { return this.add("userSelect", "auto"); }
  /** Sets `userSelect: value`. */
 select(value: Properties["userSelect"]) { return this.add("userSelect", value); }

  // verticalAlign
  /** Sets `verticalAlign: "baseline"`. */
 get vaBaseline() { return this.add("verticalAlign", "baseline"); }
  /** Sets `verticalAlign: "middle"`. */
 get vam() { return this.add("verticalAlign", "middle"); }
  /** Sets `verticalAlign: "top"`. */
 get vat() { return this.add("verticalAlign", "top"); }
  /** Sets `verticalAlign: "bottom"`. */
 get vaBottom() { return this.add("verticalAlign", "bottom"); }
  /** Sets `verticalAlign: value`. */
 va(value: Properties["verticalAlign"]) { return this.add("verticalAlign", value); }

  // visibility
  /** Sets `visibility: "visible"`. */
 get vv() { return this.add("visibility", "visible"); }
  /** Sets `visibility: "hidden"`. */
 get vh() { return this.add("visibility", "hidden"); }
  /** Sets `visibility: value`. */
 visibility(value: Properties["visibility"]) { return this.add("visibility", value); }

  // whitespace
  /** Sets `whiteSpace: "pre"`. */
 get wsp() { return this.add("whiteSpace", "pre"); }
  /** Sets `whiteSpace: "normal"`. */
 get wsn() { return this.add("whiteSpace", "normal"); }
  /** Sets `whiteSpace: "nowrap"`. */
 get wsnw() { return this.add("whiteSpace", "nowrap"); }
  /** Sets `whiteSpace: "break-spaces"`. */
 get wsbs() { return this.add("whiteSpace", "break-spaces"); }
  /** Sets `whiteSpace: "pre-wrap"`. */
 get wspw() { return this.add("whiteSpace", "pre-wrap"); }
  /** Sets `whiteSpace: "pre-line"`. */
 get wspl() { return this.add("whiteSpace", "pre-line"); }
 ...
 get wfc() { return this.add("width", "fit-content"); }
  /** Sets `width: "max-content"`. */
 get wmaxc() { return this.add("width", "max-content"); }
  /** Sets `width: "min-content"`. */
 get wminc() { return this.add("width", "min-content"); }
  /** Sets `minWidth: 0`. */
 ...
 get mwfc() { return this.add("minWidth", "fit-content"); }
  /** Sets `minWidth: "min-content"`. */
 get mwminc() { return this.add("minWidth", "min-content"); }
  /** Sets `minWidth: "max-content"`. */
 get mwmaxc() { return this.add("minWidth", "max-content"); }
  /** Sets `minWidth: value`. */
 ...
 get maxwfc() { return this.add("maxWidth", "fit-content"); }
  /** Sets `maxWidth: "min-content"`. */
 get maxwminc() { return this.add("maxWidth", "min-content"); }
  /** Sets `maxWidth: "max-content"`. */
 get maxwmaxc() { return this.add("maxWidth", "max-content"); }
  /** Sets `maxWidth: value`. */
 maxw(value: Properties["maxWidth"]) { return this.add("maxWidth", value); }
  /** Sets `maxWidth: px`. */
 maxwPx(px: number) { return this.maxw(`${px}px`); }
  /** Sets `width: "0px"`. */
 get w0() { return this.add("width", "0px"); }
  /** Sets `width: "8px"`. */
 get w1() { return this.add("width", "8px"); }
  /** Sets `width: "16px"`. */
 get w2() { return this.add("width", "16px"); }
  /** Sets `width: "24px"`. */
 get w3() { return this.add("width", "24px"); }
  /** Sets `width: "32px"`. */
 get w4() { return this.add("width", "32px"); }
  /** Sets `width: "auto"`. */
 get wa() { return this.add("width", "auto"); }
  /** Sets `width: "v"`. */
 w(v: number | string) { return this.add("width", maybeInc(v)); }
  /** Sets `width: px`. */
 wPx(px: number) { return this.add("width", `${px}px`); }

  // wordBreak
  /** Sets `wordBreak: "normal"`. */
 get wbn() { return this.add("wordBreak", "normal"); }
  /** Sets `wordBreak: "break-all"`. */
 get wbba() { return this.add("wordBreak", "break-all"); }
  /** Sets `wordBreak: "keep-all"`. */
 get wbka() { return this.add("wordBreak", "keep-all"); }
  /** Sets `wordBreak: "break-word"`. */
 get wbbw() { return this.add("wordBreak", "break-word"); }
 ...
 z(value: Properties["zIndex"]) { return this.add("zIndex", value); }
  ...
  get $(): CssProp { return this.rules as any; }

  get onHover() { return this.newCss({ selector: ":hover" }); }
  get onFocus() { return this.newCss({ selector: ":focus" }); }
  get onFocusVisible() { return this.newCss({ selector: ":focus-visible" }); }
  get onActive() { return this.newCss({ selector: ":active" }); }
  get onDisabled() { return this.newCss({ selector: ":disabled" }); }
  ...
  get ifMd() { return this.newCss({ selector: "@media screen and (min-width:600px) and (max-width:959px)" }); }
  get ifSmOrMd() { return this.newCss({ selector: "@media screen and (max-width:959px)" }); }
  get ifMdAndUp() { return this.newCss({ selector: "@media screen and (min-width:600px)" }); }
  get ifMdAndDown() { return this.newCss({ selector: "@media screen and (max-width:959px)" }); }
  get ifLg() { return this.newCss({ selector: "@media screen and (min-width:960px)" }); }
  get ifMdOrLg() { return this.newCss({ selector: "@media screen and (min-width:600px)" }); }
